...
sqlcreate = "create table superset_"+survey_id+" (state VARCHAR (50), district VARCHAR (50), block VARCHAR (50), cluster VARCHAR (50), village VARCHAR (100), institution_name VARCHAR (100), institution_id integer, gp VARCHAR (100), class VARCHAR (50), yearmonth integer, academic_year VARCHAR (50), gender VARCHAR (50), qgid integer"
